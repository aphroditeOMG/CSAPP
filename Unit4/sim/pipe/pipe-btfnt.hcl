...
word f_pc = [
	...
	(M_icode == IJXX && 
        (((M_valE > 0 && M_valA > 0 && M_valE < M_valA) ||
        (M_valE < 0 && M_valA < 0 && M_valE > M_valA) ||
        (M_valE > 0 && M_valA < 0)) &&          
        !M_Cnd)) : M_valA;
        (M_icode == IJXX &&                                        
        (((M_valA > 0 && M_valE > 0 && M_valA <= M_valE) ||
        (M_valA < 0 && M_valE < 0 && M_valA >= M_valE) ||
        (M_valA > 0 && M_valE < 0)) &&        
        M_Cnd))  : M_valE;
...
word f_predPC = [
	...
	f_icode == IJXX && f_valC > 0 && f_valP > 0 && f_valC < f_valP : f_valC;
	f_icode == IJXX && f_valC < 0 && f_valP < 0 && f_valC > f_valP : f_valC;
	f_icode == IJXX && f_valC > 0 && f_valP < 0 : f_valC;
	# end of change
	1 : f_valP;
];
...
bool D_bubble =
	...
	#(E_icode == IJXX && !e_Cnd) ||
        ...
        (E_icode == IJXX && 
	(((E_valC > 0 && E_valA > 0 && E_valC < E_valA) ||
	(E_valC < 0 && E_valA < 0 && E_valC > E_valA) ||
	(E_valC > 0 && E_valA < 0)) && 
	!e_Cnd)) 
	||
	(E_icode == IJXX && 
        (((E_valA > 0 && E_valC > 0 && E_valA <= E_valC) ||
        (E_valA < 0 && E_valC < 0 && E_valA >= E_valC) ||
        (E_valA >= 0 && E_valC <= 0)) && 
        e_Cnd)) 
	||
