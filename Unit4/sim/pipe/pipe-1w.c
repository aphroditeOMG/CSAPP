...
{
    return ((imem_error) ? (I_NOP) : (((imem_icode) == (I_POPQ)) & (
          (if_id_curr->icode) == (I_POPQ))) ? (I_POP2) : (imem_icode));
}
...
long long gen_d_dstE()
{
    return (((if_id_curr->icode) == (I_RRMOVQ) || (if_id_curr->icode) == 
      ...
      ((if_id_curr->icode) == (I_PUSHQ) || (if_id_curr->icode) == (I_POPQ)
        ...
        (I_RET) || (if_id_curr->icode) == (I_POPQ)) ? (REG_RSP) : 
      (REG_NONE));
}
...
long long gen_w_valE()
{
    return (((mem_wb_curr->destm) != (REG_NONE)) ? (mem_wb_curr->valm) : (
        (mem_wb_curr->icode) == (I_POP2)) ? (mem_wb_curr->valm) : 
      (mem_wb_curr->vale));
}
...
long long gen_F_stall()
{
    return (((((id_ex_curr->icode) == (I_MRMOVQ) || (id_ex_curr->icode) == 
            (I_POPQ)) & ((if_id_next->icode) != (I_POP2))) & (
...
{
    return ((((id_ex_curr->icode) == (I_MRMOVQ) || (id_ex_curr->icode) == 
          (I_POPQ)) & ((if_id_curr->icode) != (I_POP2))) & (
        (id_ex_curr->destm) == (id_ex_next->srca) || (id_ex_curr->destm)
         == (id_ex_next->srcb)));
}
...
long long gen_D_bubble()
{
    return ((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch))
       | (!(((id_ex_curr->icode) == (I_MRMOVQ) || (id_ex_curr->icode) == 
            (I_POP2) || (id_ex_curr->icode) == (I_POPQ)) & (
